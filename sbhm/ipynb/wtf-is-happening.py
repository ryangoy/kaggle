...
df_train = pd.read_csv(join(ds_dir, 'train.csv'), parse_dates=['timestamp'])
df_test = pd.read_csv(join(ds_dir, 'test.csv'), parse_dates=['timestamp'])
df_macro = pd.read_csv(join(ds_dir, 'macro.csv'), parse_dates=['timestamp'])
