...
# import sys
# sys.path.insert(0, '..')
# from pipeline.load_data import load_trn_data

# empty dictionary
pneumonia_locations = {}
# load table
with open(os.path.join('/home/ryan/cs/datasets/rsna/stage_1_train_labels.csv'), mode='r') as infile:
    # open reader
...
folder = '/home/ryan/cs/datasets/rsna/stage_1_train_images'
filenames = os.listdir(folder)
random.shuffle(filenames)
# split into train and validation filenames
n_files = len(filenames)
n_valid_samples = int(n_files*0.1)
...
# create network and compiler# creat 
...
# train_gen, valid_gen = load_trn_data(TRN_IMAGES_PATH, TRN_LABELS_PATH)
