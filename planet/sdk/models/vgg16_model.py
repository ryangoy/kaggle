...
class VGG16(Model):
    ...
    def __init__(self, name='VGG16', labels=None, num_epochs=1,
        ...
        augmentation_params['rescale'] = 1./255
        self.train_gen = image.ImageDataGenerator(**augmentation_params)
    ...
    def test(self, X_test, y_test=None):
        test_generator = self.test_gen.flow_from_directory(X_test, batch_size=self.batch_size, 
            target_size = (224, 224))
