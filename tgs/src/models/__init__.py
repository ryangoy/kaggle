...
def backbone(backbone_name):
    ...
    """
    if 'vggunet' in backbone_name:
        from .vgg import VGGUNet as b
    else:
...
def load_model(filepath, backbone_name='vggunet', convert=False, nms=True, class_specific_filter=True):
