...
class ExtraTreesRegressor(Model):
    """
    Basic ElasticNet wrapper.
    """
    def __init__(self, log_data=False, name='ExtraTreesRegressor', features=None):
        self.model = None
    ...
    def train(self, X_trn, y_trn, X_val=None, y_val=None):
        ...
        self.model = ensemble.ExtraTreesRegressor(max_features=100, max_depth=6, random_state=SEED)
